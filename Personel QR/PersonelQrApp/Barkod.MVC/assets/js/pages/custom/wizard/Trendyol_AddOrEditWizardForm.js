...
// Class definition
var Trendyol_AddOrEditWizardForm = function () {
	// Base elements
	var _wizardEl;
	var _formEl;
	var _wizardObj;
	...
	return {
		// public functions
		init: function () {
			_wizardEl = KTUtil.getById('TYaddOrEditWizard');
			_formEl = KTUtil.getById('TYaddOrEditWizardForm');
...
jQuery(document).ready(function () {
	Trendyol_AddOrEditWizardForm.init();
});
